...
CARS: list[Car] = [
    Car(
        ...
        location="Delhi", body_type="Hatchback",
    ...
    Car(
        ...
        location="Bangalore", body_type="SUV",
    ...
    Car(
        ...
        location="Chennai", body_type="SUV",
    ...
    Car(
        ...
        location="Hyderabad", body_type="SUV",
    ...
    Car(
        ...
        location="Kolkata", body_type="SUV",
    ...
    Car(
        ...
        location="Mumbai", body_type="Hatchback",
    ...
    Car(
        ...
        location="Delhi", body_type="Sedan",
    ...
    Car(
        ...
        location="Jaipur", body_type="Hatchback",
    ...
    Car(
        ...
        location="Ahmedabad", body_type="Sedan",
