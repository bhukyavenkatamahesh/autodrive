...
import { cars, filterCars } from '@/lib/mockData';
...
function CarsContent() {
  ...
  useEffect(() => {
    ...
    if (fuelType) setFilters(f => ({ ...f, fuelType }));
  ...
  let results = filterCars({ ...filters, search });
  ...
  else if (sortBy === 'mileage-asc') results = [...results].sort((a, b) => a.mileage - b.mileage);
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="bg-white border-b border-slate-100 py-5">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-slate-500 text-sm">{results.length} cars found</p>
